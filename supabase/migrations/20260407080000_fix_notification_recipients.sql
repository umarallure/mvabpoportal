-- Notifications now fan out to all admin/super_admin users from app_users
-- instead of targeting leads.user_id directly.

-- ============================================================
-- TRIGGER 1: New Lead → notify all admins
-- ============================================================
...
-- ============================================================
-- TRIGGER 2: Lead Updated → notify all admins on status/attorney change
-- ============================================================
...
-- ============================================================
-- TRIGGER 3: Note Added → notify all admins
-- ============================================================
