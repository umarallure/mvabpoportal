...
// The product_guide tables are shared across portals (same Supabase project).
// This portal only reads and writes its own rows.
export const PRODUCT_GUIDE_PORTAL_KEY = 'publisher'
