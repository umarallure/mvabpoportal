...
const showLawyerBlockedMessage = () => {
  const description = 'Your account is a lawyer account and cannot access the Publisher Portal. Please contact an administrator if you believe this is a mistake.'
  toast.add({
        ...
        <section class="grid w-full gap-10 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
          <div class="space-y-8">
            <div class="space-y-4">
              ...
              <h1 class="text-4xl font-semibold leading-tight text-white md:text-5xl">Secure entry for your MVA Campaign.</h1>
